...
> [!proof]- Demostración:
> Todo grafo conexo admite un árbol generador, esto es un sub grafo que contiene todos los vértices y es un árbol.
> 
...
Una cota inferior del número cromático de $G$ es el número $p$ si $K_p$ es un sub grafo de $G$, notemos que la recíproca es falsa.
