...
- ***Care-of address (COA) fields.*** Una lista de uno o mas COAs provistas por el agente externo. El agente externo seleccionara una de las direccionas cuando se registra con su agente local.
