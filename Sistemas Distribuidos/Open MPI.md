Es un framework de coordinación basado en transmisión y recepción de mensajes. Se utiliza como biblioteca con abstracciones de uso general con foco en cómputo distribuido.
